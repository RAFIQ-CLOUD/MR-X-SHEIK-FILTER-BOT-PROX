...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton("🍁ɢʀᴏᴜᴩ🍁", url="https://t.me/SheikXRequestMoviesOffl"),
            InlineKeyboardButton("⚡ᴄʜᴀɴɴᴇʟ⚡", url="https://t.me/SheikXMoviesOffl")
        ]
    )
    ...
    btn.append(
    [InlineKeyboardButton("🤔𝗛𝗢𝗪 𝗧𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗🤔", url="https://t.me/SheikXMoviesOffl/53"),]
)
    if n_offset == 0:
        btn.append(
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('⚡ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ⚡', url=f'https://t.me/SheikXMoviesOffl')
        ], [
            InlineKeyboardButton('⚡ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ 1.O ⚡', url='https://t.me/SheikXRequestMoviesOffl'),
            InlineKeyboardButton('⚡ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ 2.O ⚡', url='https://t.me/+Z2JGfPPoUKY5NzU1')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ᴜᴩᴅᴀᴛᴇꜱ', url='https://t.me/SheikXMoviesOffl'),
